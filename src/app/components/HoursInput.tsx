      ...
      <Card variant="gradient" className="h-full">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle>Current Hours (MINT/System)</CardTitle>
...
Tuesday: 9:00 AM – 10:00 PM`}
            className="w-full h-72 p-4 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 resize-none text-sm font-mono bg-white placeholder:text-gray-400"
          />
        </CardContent>
      </Card>
