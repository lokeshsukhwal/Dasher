  ...
  return (
    <header className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-blue-400/10 to-indigo-400/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="text-center">
          ...
          <p className="max-w-2xl mx-auto text-xl text-blue-100 mb-10 leading-relaxed">
            Instantly compare business hours and generate professional verification remarks.
            Save time and ensure accuracy in your operations.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              ...
              <span className="text-sm text-white font-semibold">Instant Analysis</span>
            </div>
            <div className="flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <Shield className="w-5 h-5 text-emerald-300" />
              <span className="text-sm text-white font-semibold">Accurate Detection</span>
            </div>
            <div className="flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <Sparkles className="w-5 h-5 text-purple-300" />
              <span className="text-sm text-white font-semibold">Auto Remarks</span>
            </div>
          </div>
        </div>
      </div>
